...
The confirmed public support contact is `cpoapps@gmail.com`, with `Sipke Lautenbach (CPO Apps)` shown as the legal contact. The directory is deployed unchanged to GitHub Pages, and the locale-specific URLs are saved in App Store Connect.
